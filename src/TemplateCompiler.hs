...
data SchemaVar = SchemaVar { varName :: String, varType :: String, isKey :: Bool, isRequired :: Bool } deriving (Show, Data, Typeable)
data Schema = Schema { name :: String, route :: String, keyField :: String, schemaVars :: [SchemaVar] } deriving (Show, Data, Typeable)
